...
-(void)applicationDidFinishLaunching:(NSNotification * )aNotification
{
    ...
    [window setTitle:@"macOS Tessellation Shader"];
    [window center];
...
-(void)prepareOpenGL
{
    ...
    glShaderSource(gTessellationControlShaderObject,1,(const char **)&tessellationControlShaderSourceCode,NULL);
  ...
  //************TESSELLATION SHADER EVALUATION LOG **************
    //create shader
...
-(void)drawView
{
    ...
    //draw triangle
    glDrawArrays(GL_PATCHES,0,4); //3 with its x,y,z
