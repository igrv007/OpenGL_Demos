...
-(void)applicationDidFinishLaunching:(NSNotification * )aNotification
{
    ...
    [window setTitle:@"macOS Smiley on Keyss"];
    [window center];
...
-(void)drawView
{
    ...
    //texture coordinate for full face
const GLfloat texCoords1[] =
    ...
    //texture coordinate for left face
    ...
    if(whichKeyPressed == 1)
     glBufferData(GL_ARRAY_BUFFER,
      ...
      glBufferData(GL_ARRAY_BUFFER,
                   ...
                   texCoords2,
                   GL_DYNAMIC_DRAW);
    else if(whichKeyPressed == 3)
      glBufferData(GL_ARRAY_BUFFER,
                   sizeof(texCoords3),
                    texCoords3,
                          GL_DYNAMIC_DRAW);
    else if(whichKeyPressed == 4)
      glBufferData(GL_ARRAY_BUFFER,
                   sizeof(texCoords4),
                   texCoords4,
                   GL_DYNAMIC_DRAW);
