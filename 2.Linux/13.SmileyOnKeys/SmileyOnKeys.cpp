             ...
             case KeyPress: //parallel to WM_KEYDOWN 
                  ...
                  switch(keysym)
                 {
                    ...
                    case XK_f:
                         ...
                         break;
                     case XK_1:
                      gi_Digit_Is_Pressed=1;
                     break;
                     case XK_2:
                      gi_Digit_Is_Pressed=2;
                     break;
                     case XK_3:
                      gi_Digit_Is_Pressed=3;
                     break;
                     case XK_4:
                      gi_Digit_Is_Pressed=4;
                     break;
                    default:
                         break;
                  }
...
const GLfloat texCoords4[]=
  ...
  if(gi_Digit_Is_Pressed ==1)
     glBufferData(GL_ARRAY_BUFFER,
                  sizeof(texCoords1),
                  texCoords1,
                  GL_DYNAMIC_DRAW);
  else if(gi_Digit_Is_Pressed ==2)
	  glBufferData(GL_ARRAY_BUFFER,
		  sizeof(texCoords2),
		  texCoords2,
		  GL_DYNAMIC_DRAW);
  else if(gi_Digit_Is_Pressed== 3)
	  glBufferData(GL_ARRAY_BUFFER,
		  sizeof(texCoords3),
		  texCoords3,
		  GL_DYNAMIC_DRAW);
  else if(gi_Digit_Is_Pressed == 4)
	  glBufferData(GL_ARRAY_BUFFER,
		  sizeof(texCoords4),
		  texCoords4,
		  GL_DYNAMIC_DRAW);
