...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpszCmdLine,int iCmdShow)
{
  ...
  //Register class
	...
	hwnd =CreateWindow(szAppName,
			TEXT("OpenGL Programmable Pipeline 2D Rotation"),
			WS_OVERLAPPEDWINDOW ,
			uiXPos,
			uiYPos,
			WIN_WIDTH,
...
//ORDER IS IMPORTANT
 ...
 //pass above modelviewprojection matrix to the vertex shader in 'u_mvp_matrix' shader variable
  ...
  ////OpenGL drawing 
   ...
   // PMG Correction -> here the order should be
   // 1 Translate
   // 2 Rotate
   // 3 Scale
   // mvp = projection * mvp
...
=======
scaleMatrix = modelViewMatrix * vmath::scale(0.75f,0.75f,0.75f);
    modelViewMatrix = modelViewMatrix * scaleMatrix;
>>>>>>> 30385374fa5d4614c01c4c3f1f1810a77bf2b814
