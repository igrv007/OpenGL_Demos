	...
	if(iInfoLogLength >0)
	{
		...
		if(szInfoLog != NULL)
		{
			...
			glGetShaderInfoLog(gVertexShaderObject,
				               ...
				               szInfoLog);             //S3
		    check_gl_error();
		    fprintf(gpFile, "Vertex Shade Compilation Log:%s\n",szInfoLog );
		    free(szInfoLog);
		    uninitialize();
		    exit(0);
		}
...
const GLchar *fragmentShaderSourceCode=
  ...
  //attach vertex shder program to shader program 
  glAttachShader(gShaderProgramObject,gVertexShaderObject);
   check_gl_error();
  
  //attach fragment shader programm to shader program
...
//get the linking error status in a parameterized variable
...
//get MVP uniform location
    ...
    gMVPUniform=glGetUniformLocation(gShaderProgramObject,
    	                            "u_mvp_matrix");
    check_gl_error();
...
//#####################end of TRIANGLE Relates VAo and Vbo###########
